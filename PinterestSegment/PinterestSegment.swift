...
@objc public class PinterestSegmentStyle: NSObject {

    @objc public var indicatorColor = UIColor(white: 0.95, alpha: 1)
    @objc public var titleMargin: CGFloat = 15
    @objc public var titlePendingHorizontal: CGFloat = 14
    @objc public var titlePendingVertical: CGFloat = 14
    @objc public var titleFont = UIFont.boldSystemFont(ofSize: 14)
    @objc public var normalTitleColor = UIColor.lightGray
    @objc public var selectedTitleColor = UIColor.darkGray
    // public init() {}
}



@objc public class PinterestSegment: UIControl {

    @objc public var style: PinterestSegmentStyle {
        didSet {
            reloadData()
        }
    }
    ...
    @objc public var valueChange: ((Int) -> Void)?
    ...
    //MARK:- life cycle
    @objc public convenience init(frame: CGRect, titles: [String]) {
        self.init(frame: frame, segmentStyle: PinterestSegmentStyle(), titles:  titles)
    }

    @objc public init(frame: CGRect, segmentStyle: PinterestSegmentStyle, titles: [String]) {
    ...
    @objc public func setSelectIndex(index: Int,animated: Bool = true) {
